...
//скоротити кількість рядків та достати змінні більш зручним способом
...
const charactersShortInfo = characters.map(({gender, status, ...rest}) => rest)
...
const {name, years: age, isAdmin = false} = user1       //зміна назви через : ТІЛЬКИ У ЛІВІЙ ЧАСТИНІ
...
const all = {...employee, age: 18, salary: 25}
console.log(all)
